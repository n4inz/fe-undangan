...
const StepH = ({ number, nextStep, formData, setFormData, onFormChange, partName, title }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (responseData?.form?.ceritaJadian == null) {
          nextStep();
          // console.log("Skipping step because ceritaJadian is null");
          return;
        }
