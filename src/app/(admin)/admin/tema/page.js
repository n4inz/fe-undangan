...
const Tema = () => {
  ...
  const fetchData = useCallback(async (page, limit, searchQuery) => {
    try {
      const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/tema`, {
  ...
  const handleDelete = () => {
    ...
    try {
      axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/tema/${selectedRow.id}`, {
        withCredentials: true,
      })
        .then(response => {
      ...
      <div className="flex min-h-screen pt-10">
        ...
        <AlertDialogContent>
          ...
          <div className="p-4">
            ...
            <div className='mb-2'>
              <Link href="/admin/tema/add/0"><Button className="bg-black">Add</Button></Link>
